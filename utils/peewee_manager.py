...
from peewee_async import Manager, PooledPostgresqlDatabase, PooledMySQLDatabase, execute
...
def declarative_base(*args, **kwargs):
    ...
    # db = PooledPostgresqlDatabase(*args, **kwargs)
    db = PooledMySQLDatabase(**kwargs)
...
#     #     await KeyValue.objects.execute(KeyValue.select())
#     # qps = 40000 / (time.time() - now)
...
#         )
#
#     return json({'objects': serialized_obj, "qps": 0})
#
#
